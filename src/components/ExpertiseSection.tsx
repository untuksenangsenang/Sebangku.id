  ...
  return (
    <section className="py-16 md:py-24 lg:py-28 bg-[#F5F7FA]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        <div className="grid md:grid-cols-[300px_1fr] lg:grid-cols-[380px_1fr] gap-6 md:gap-10 items-end">
          ...
          <div className="hidden md:flex justify-center items-end">
            <Image
              ...
              width={380}
              height={480}
              className="w-full max-w-[300px] lg:max-w-[380px] h-auto object-contain object-bottom"
              priority
            />
          </div>
